...
class LayerManager {
    constructor (renderer) {
         ...
         * - 每一项为 [type, layerIdx|drawID|folderName, listIdx, dirty]，标记一个shader的分界点
         *   - [0] - type - 0(值分割)|1(角色分割)|2(文件夹分割)
         *   - [1] - layerIdx|drawID|folderName - 分割的layer排序值|分割角色ID|分割文件夹名称
         *   - [2] - listIdx - 分割处在列表中的位置
         * - 当第三项不为null时，优先使用
     ...
     */
    getSortedDrawList (drawList, startIdx, endIdx) {
        // 将所有dirty文件夹进行排序
